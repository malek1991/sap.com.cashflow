									...
									tiles: [
										{
											...
											properties: {
												title: "Peer Analysis Cash Flow",
												targetURL:
													"#sapappcashflowpeeranalysiscashflow-display",
											},
										},
									],
								},
				...
				ClientSideTargetResolution: {
					adapter: {
						config: {
							inbounds: {
								"sapappcashflowpeeranalysiscashflow-display": {
									semanticObject: "sapappcashflowpeeranalysiscashflow",
									action: "display",
									description: "Fiori application cash flow analysis",
									title: "Peer Analysis Cash Flow",
									signature: {
										parameters: {},
									},
									resolutionResult: {
										...
										additionalInformation:
											"SAPUI5.Component=sap.app.cashflow.peeranalysiscashflow",
										url: sap.ui.require.toUrl(
											"sap/app/cashflow/peeranalysiscashflow"
										),
									},
								},
							},
